[原地址](https://github.com/open-spaced-repetition/ts-fsrs)
---
...
```
ohpm install @rv/ts-fsrs
```

# 例子

```typescript
import {createEmptyCard, formatDate, fsrs, generatorParameters, Rating, Grades} from '@rv/ts-fsrs';
...
```typescript
import {Card, createEmptyCard} from "@rv/ts-fsrs";
...
```typescript
import {Card, createEmptyCard, generatorParameters, FSRSParameters} from "@rv/ts-fsrs";
